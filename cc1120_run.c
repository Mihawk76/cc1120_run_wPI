...
uint8_t Panasonic_off[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_on[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_17[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_18[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_19[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
                          0xC6 ,0x01 ,0x9E ,0x01 ,0xFF ,0x04 ,0xC0 ,0x0D ,0x01 ,0x40 ,
                          0x9E ,0x06 ,0x40 ,0xC0 ,0x40 ,0x04 ,0x07 ,0x20 ,0x00 ,0x00 ,
                          0x00 ,0x60 ,0x09 ,0x80 ,0xB3 ,0x2A ,0x01 ,0x00 ,0xF4 ,0x0D ,
                          0x01 ,0x40 ,0x9F ,0x06 ,0x98 ,0xC0 ,0x40 ,0x04 ,0x07 ,0x20 ,
                          0x00 ,0x9C ,0x24 ,0x01 ,0xFE ,0x00 ,0x00 ,0x70 ,0x07 ,0x00 ,
                          0x00 ,0x81 ,0x00 ,0x00 ,0x8B ,0x37 ,0x83};
uint8_t Panasonic_20[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_21[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_22[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_23[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_24[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_25[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_26[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_27[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_28[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_29[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
...
uint8_t Panasonic_30[] = {0x40 ,0x11 ,0x00 ,0x00 ,0x42 ,0x3D ,0x15 ,0x00 ,0x00 ,0x37 ,
	...
	if (( temp_byte == 0x07)||( temp_byte == 0x08)){
		...
		if(rx_byte != 0) {
			...
			if((temp_byte & 0x1F) == RX_FIFO_ERROR) {
			    ...
			    *(uint16_t*)&temp[2] =  0x0000; //(2 byte)
			    // *(uint16_t*)&txBuffer[4] = 0xC445; //id 
    			*(uint16_t*)&temp[4] = 0x3D42; //id 
					printf("uint8_t Panasonic_[] = {");
					int loop = 0;
					for (i=0;i<rx_byte;i++) {
